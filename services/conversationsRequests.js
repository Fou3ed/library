            ...
            data: [
              {
                $group: {
                  ...
                  updated_at: { $first: '$updated_at' },
                  unread_messages: { $first: '$unread_messages.unread_count' },
                  total_messages_client: { $first: { $sum: { $ifNull: ['$total_messages.total_messages', 0] } } },
                  paid_messages_client: { $first: { $sum: { $ifNull: ['$paid_messages.paid_messages', 0] } } },
                  unpaid_messages_client: { $first: { $sum: { $ifNull: ['$unpaid_messages.unpaid_messages', 0] } } },
